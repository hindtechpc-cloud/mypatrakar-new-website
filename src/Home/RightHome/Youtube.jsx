...
const YouTube = () => {
    ...
    return (
        <div className="my-2 mt-5 font-sans">
            ...
            <div className="flex flex-wrap gap-5 w-full overflow-y-auto h-[500px] hide-scroll">
                {videos.map((video) => (
                    <div key={video.guid} className="bg-white shadow-xl w-full rounded-lg overflow-hidden transform transition-all hover:scale-105">
                        <iframe
