...
//                 <div
//                   id="videoSlider"
//                   className="flex gap-2 overflow-x-scroll scrollbar-hide pb-2 scroll-smooth items-center justify-center mx-auto"
//                 >
//                   {videos.map((video) => (
//                     <div
//                       key={video.id}
//                       className="min-w-[300px] max-w-[310px] bg-gray-50 rounded-lg shadow hover:shadow-md transition cursor-pointer"
//                     >
//                       <a
//                         href={`https://www.youtube.com/watch?v=${video.snippet.resourceId.videoId}`}
//                         target="_blank"
