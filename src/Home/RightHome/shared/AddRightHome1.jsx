...
//             Reach   readers Premium sidebar placement. High visibility for your brand.
//           </p>
...
export default function AddRightHome1({ adsData, className }) {
  const { getSettingStatus } = useSettingsContext();
  ...
  return (
    <div className={className}>
      {isAdDataValid ? (
        ...
        <PosterAd isAdvertiseWithUsPageEnabled={isAdvertiseWithUsPageEnabled} />
      )}
    </div>
  );
}
