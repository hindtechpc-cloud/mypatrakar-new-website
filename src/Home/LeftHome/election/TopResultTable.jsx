...
//               <th className="py-3 px-4 font-semibold text-right rounded-tr-lg">
//                 परिणाम (%)
//               </th>
//             </tr>
//           </thead>
...
//               const percentage = (
//                 (parseInt(party.seats_won) / totalVotes) *
//                 100
//               ).toFixed(1);
//               return (
//                 <tr
...
const TopResultTable = ({ results }) => {
  ...
  // Rank colors (agar kabhi rank column enable karna ho to)
  const rankColors = [
    "linear-gradient(135deg, #FFD700, #FFA500)", // Gold
    "linear-gradient(135deg, #C0C0C0, #A9A9A9)", // Silver
    "linear-gradient(135deg, #CD7F32, #8C6B46)", // Bronze
  ];
