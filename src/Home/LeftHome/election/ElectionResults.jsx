        ...
        <div className="w-full lg:w-2/5 flex flex-col items-center">
          ...
          <div className="relative w-64 h-64 rounded-full shadow-lg mb-4">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center bg-white rounded-full w-32 h-32 m-auto shadow-md border border-gray-100">
              <div className="mb-1">
                <img src={image} alt="Election related image" className="h-10 w-auto" />
              </div>
              <p className="text-gray-600 text-sm font-medium">Total Seats</p>
              <p className="text-gray-800 font-bold text-xl">{totalSeats}</p>
            </div>
            ...
            return (
              <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-gray-600">{party.party_name}</span>
                  <div 
                ...
                <div className="flex justify-between items-end">
                  <div>
                    <p className="text-2xl font-bold text-gray-800">{party.seats_won}</p>
