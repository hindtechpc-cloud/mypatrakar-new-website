...
export default function JournalistYouTubeFeed() {
  ...
  return (
    <div className="py-6 max-w-6xl mx-auto">
      ...
      {/* Error State */}
      {!loading && error && (
        <div className="mt- p-6 bg-red-50 border border-red-100 rounded-xl flex flex-col items-center justify-center text-center">
      ...
      {!loading && !error && videos.length === 0 && (
        <div className="mt- p-8 bg-gray-50 border border-gray-200 rounded-xl text-center">
...
// const CACHE_KEY = "journalist_videos_cache";
...
//         if (!youtubeUrl) {
//           throw new Error("No YouTube channel found in your profile.");
//         }
...
//         const videoList = await getVideosFromPlaylist(playlistId);
//         if (!videoList?.length) throw new Error("No videos found.");

//         // ✅ cache first 9 videos only
//         const initialVideos = videoList.slice(0, 9);
//         sessionStorage.setItem(CACHE_KEY, JSON.stringify(initialVideos));
...
//       setVideos(newVideos);
//       sessionStorage.setItem(CACHE_KEY, JSON.stringify(newVideos));
//       setVisibleVideos((prev) => prev + 6);
//     } catch (err) {
