    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="py-4 sticky top-0 z-20 shadow-md" style={{ backgroundColor: webTheme["bg-color"] || "#b91c1c" }}>
        <div className="max-w-5xl mx-auto px-4 flex items-center gap-4">
          ...
          <button onClick={() => setShowMobileFilters(!showMobileFilters)} className="md:hidden p-2 bg-white rounded-lg shadow-sm text-gray-700 hover:bg-gray-100" aria-label="Toggle filters">
            <FaFilter />
          </button>
        </div>
      </div>
