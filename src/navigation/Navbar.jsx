...
const Navbar = () => {
  ...
  return (
    <div
      className={`bg-red-800 text-white mx-0 
    ...
    >
      ...
      <div
        className={`fixed lg:hidden block top-0 left-0 w-3/4 max-w-sm h-full bg-red-700 text-white z-50 transform transition-transform duration-300 ease-linear ${
